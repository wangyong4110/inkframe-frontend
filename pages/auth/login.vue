  ...
  <div class="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4">
    <div class="max-w-md w-full">
      ...
      <div class="text-center mb-8">
        ...
        <h2 class="mt-4 text-2xl font-semibold text-gray-800">欢迎回来</h2>
      </div>
      ...
      <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
        ...
        <div class="flex border-b border-gray-200 mb-6">
          <button
            ...
            :class="activeTab === 'password' ? 'border-b-2 border-purple-600 text-purple-600' : 'text-gray-500 hover:text-gray-700'"
        ...
        <div class="mt-6">
          <div class="relative">
            ...
            <div class="relative flex justify-center text-sm">
              <span class="px-2 bg-white text-gray-400">第三方登录</span>
            </div>
          </div>
          <div class="mt-4 flex justify-center space-x-5">
            ...
            <button
              ...
              title="微信登录"
              class="w-11 h-11 flex items-center justify-center rounded-full border border-gray-200 hover:border-[#07C160] hover:bg-[#07C160]/5 transition-colors group"
            >
            ...
            <button
              ...
              title="抖音登录"
              class="w-11 h-11 flex items-center justify-center rounded-full border border-gray-200 hover:border-[#161823] hover:bg-gray-50 transition-colors group"
            >
              <svg viewBox="0 0 24 24" class="w-6 h-6 fill-gray-400 group-hover:fill-[#161823] transition-colors" xmlns="http://www.w3.org/2000/svg">
        ...
        <p class="mt-6 text-center text-sm text-gray-500">
          没有账号？
          <NuxtLink to="/auth/register" class="text-purple-600 hover:underline font-medium">注册</NuxtLink>
        </p>

        <!-- 开发模式快捷登录 -->
        <div v-if="isDev" class="mt-6 pt-5 border-t border-dashed border-gray-200">
          <p class="text-center text-xs text-gray-400 mb-3">开发模式</p>
          <button
            type="button"
